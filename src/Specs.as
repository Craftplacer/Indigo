...
public class Specs {
	...
	public static var variableColor:int = 0xf2a725; // Scratch 1.4: 0xF3761D
	public static var listColor:int = 0xeb9730; // Scratch 1.4: 0xD94D11
	public static var procedureColor:int = 0x943cb2; // 0x531E99;
	public static var parameterColor:int = 0x5947b1;
	public static var extensionsColor:int = 0xaaa8c1; // 0x72228C; // 0x672D79;

	private static const undefinedColor:int = 0xD42828;

	public static const categories:Array = [
	 // id   category name	color
		[0,  "undefined",	0xFF200C],
		[1,  "Motion",		0x1753CC],
		[2,  "Looks",		0x7335cf],
		[3,  "Sound",		0xad18b8],
		[4,  "Pen",			0x14a977], // Scratch 1.4: 0x009870
		[5,  "Events",		0xcc8d34],
		[6,  "Control",		0xe1b521],
		[7,  "Sensing",		0x2ca5e2],
		[8,  "Operators",	0x6cc71b],
		[9,  "Data",		variableColor],
		[10, "More Blocks",	procedureColor],
		[11, "Parameter",	parameterColor],
		[12, "List",		listColor],
		[13, "Mod Blocks",	0x3F51B5],
	...
	public static var commands:Array = [
		...
		["set y to %n",										" ", 1, "ypos:",					0],
		["change z by %n",									" ", 1, "changeZposBy:",			10],
		["set z to %n",										" ", 1, "zpos:",					0],
		["--"],
		...
		["backdrop 0x",										"r", 102, "backgroundIndex"],

		// sound
		["play sound %m.sound",								" ", 3, "playSound:",						"pop"],
		["play sound %m.sound until done",					" ", 3, "doPlaySoundAndWait",				"pop"],
		["stop all sounds",									" ", 3, "stopAllSounds"],
		["stop sound %m.sound",								" ", 3, "stopSound",						"pop"],
		["pause sound %m.sound",							" ", 3, "pauseSound",						"pop"],
		["resume sound %m.sound",							" ", 3, "resumeSound",						"pop"],
		["-"],
		["paused position of sound %m.sound",				"r", 3, "pausePosition", 					"pop"],
		["current position of sound %m.sound",				"r", 3, "currentPosition", 					"pop"],
		["-"],
		...
		["is clone?",										"b", 6, "isClone"],
		["-"],
		["counter",											"r", 6, "COUNT"],
		["clear counter",									" ", 6, "CLR_COUNT"],
		["increase counter",								" ", 6, "INCR_COUNT"],
		...
		["run without screen refresh",										"c", 106, "warpSpeed"],
		["-"],
		...
		["increase counter",								" ", 106, "INCR_COUNT"],
		...
		["user id",																				"r", 107, "getUserId"],
		// operators
		["%m.booleanValue",									"b", 13, "booleanValue", true],
		["%s",									"b", 13, "parseBoolean", true],
		["%n + %n",																				"r", 8, "+",					"", ""],
		["%n - %n",																				"r", 8, "-",					"", ""],
		["%n * %n",																				"r", 8, "*",					"", ""],
		["%n / %n",																				"r", 8, "/",					"", ""],
		...
		["%m.list index of %s",								"r", 12, "list:findIndex:ofList:"],
		["-"],
		["upload file to %m.list", 							" ", 12, "list:uploadFile:toList:"],
		["-"],
		...
		// Mod Blocks
		["if %b then %s else %s",							"r", 13, "shortIf"],
		["set turbo mode to %b",							   " ", 13, "setTurboMode"],
		["set stage size to %n x %n",							" ", 13, "setStageSize", 480, 360],
		["set framerate to %n",							" ", 13, "setFrameRate", 60],
		["show framerate readout"," ",13,"showFrameRateReadout",60],
	];
}}
