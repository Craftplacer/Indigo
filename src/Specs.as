...
public class Specs {
	...
	public static var variableColor:int = 0xFFC107; // Scratch 1.4: 0xF3761D
	public static var listColor:int = 0xFF9800; // Scratch 1.4: 0xD94D11
	public static var procedureColor:int = 0x607D8B; // 0x531E99;
	public static var parameterColor:int = 0x37474F;
	...
	public static const categories:Array = [
	 // id   category name	color
		[0,  "undefined",	0xF44336],
		[1,  "Motion",		0xE91E63],
		[2,  "Looks",		0x9C27B0],
		[3,  "Sound",		0x673AB7],
		[4,  "Pen",			0x3F51B5], // Scratch 1.4: 0x009870
		[5,  "Events",		0x2196F3],
		[6,  "Control",		0x009688],
		[7,  "Sensing",		0x4CAF50],
		[8,  "Operators",	0x8BC34A],
		[9,  "Data",		variableColor],
		[10, "More Blocks",	procedureColor],
		[11, "Parameter",	parameterColor],
		[12, "List",		listColor],
		[13, "Mod Blocks",	0x9E9E9E],
